...
public class AIClient implements Runnable
{
   ...
   {
       int move;
       move = IDS(currentBoard);

       return move;
   }

   public int IDS(GameState game)
   {
       int finalMove = 0;
       int finalState = -1000000; //Arbritrarily high negative value
       int state;
       ...
       for(int i=1; i < 7 ; i++)
       {
           ...
           while (true) {
               ...
               if (game.moveIsPossible(i))
               {
                   ...
                   state=minMax(gamestate, depth,player2);
   ...
   public int minMax(GameState minBoard, int depth,int player)
   {
       int finalState = 0;
       int state;
       int player1 = player;
       ...
       for(int i = 1;i<7;i++)
       {
           ...
           if(player == player1) {
               ...
               finalState = -1000000;
              state=minMax(gamestate,--depth,player1);
   ...
   public int getUtility(GameState game,int player) {
       if(player == 1) {
           return (game.getScore(1) - game.getScore(2));
       }
       else {
